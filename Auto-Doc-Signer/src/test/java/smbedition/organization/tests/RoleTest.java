...
//@Description("Create Accounts Manager role - positive test")
//public void testCreateAccountsManagerRole() {
//    Response response = RoleService.createRole("Accounts Manager", "ACM-001", "Deals with accounts");
//    Assert.assertTrue(
//            response.getStatusCode() == 200 || response.getStatusCode() == 201,
//            "Expected 200/201 for valid Accounts Manager role"
//    );
...
//
//    @Test(priority = 3)
//    @Story("Create HR Manager ")
//    @Description("Create HR Manager role - positive test")
//    public void testCreateHRManagerRole() {
//        Response response = RoleService.createRole("HR Manager", "HR-002", "Handles HR operations");
//        Assert.assertTrue(
//                response.getStatusCode() == 200 || response.getStatusCode() == 201,
//                "Expected 200/201 for valid HR Manager role"
//        );
//        Allure.addAttachment("Create HR Manager Role API Response", response.getBody().asPrettyString());
//    }
//
//    @Test(priority = 4)
//    @Description("Attempt to create role with empty name - negative test")
//    public void testCreateRoleWithEmptyName() {
//        Response response = RoleService.createRole("", "INV-001", "Missing role name");
//        Assert.assertTrue(
//                response.getStatusCode() == 400 || response.getStatusCode() == 409,
//                "Expected 400/409 for invalid role with empty name"
//        );
//        Allure.addAttachment("Create Empty Role Name API Response", response.getBody().asPrettyString());
//    }
//
//    @Test(priority = 5)
//    @Story("Create Duplicate Role ")
//    @Description("Attempt to create role with duplicate roleId - negative test")
//    public void testCreateDuplicateRoleId() {
//        Response response = RoleService.createRole("Duplicate Role", "ACM-001", "Duplicate roleId");
//        Assert.assertTrue(
//                response.getStatusCode() == 400 || response.getStatusCode() == 409,
//                "Expected 400/409 for duplicate roleId"
//        );
//        Allure.addAttachment("Create Duplicate Role API Response", response.getBody().asPrettyString());
//    }
//
//
//    // ================== Get Roles ==================
//    @Test(priority = 6, description = "Get role list")
...
//    }
//
//   @Test(priority = 7, description = "Get single role details")
