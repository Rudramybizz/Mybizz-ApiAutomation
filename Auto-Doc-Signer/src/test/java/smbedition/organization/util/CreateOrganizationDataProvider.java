...
//    @DataProvider(name = "validOrganizationData")
//    public static Object[][] validOrganizationData() {
//        return new Object[][]{
//                {createValidOrganizationData("Tech Solutions Inc"), "Valid organization 1"},
//                {createValidOrganizationData("Global Enterprises Ltd"), "Valid organization 2"},
//                {createValidOrganizationData("Innovation Hub Pvt Ltd"), "Valid organization 3"}
//        };
//    }
    ...
    public static Object[][] fieldLengthBoundaryData() {
        return new Object[][]{
                ...
                {createOrgWithFieldLength("name", 200), "Name max length (200 chars)"},
                {createOrgWithFieldLength("address", 10), "Address min length (10 chars)"},
                {createOrgWithFieldLength("address", 500), "Address max length (500 chars)"},
                {createOrgWithFieldLength("mandal_or_taluk", 1), "Mandal/Taluk min length (1 char)"},
                {createOrgWithFieldLength("mandal_or_taluk", 100), "Mandal/Taluk max length (100 chars)"}
        };
    }
    ...
    public static Object[][] invalidNameData() {
        return new Object[][]{
                ...
                {createOrgWithName(generateLongString(201)), "Name too long (201 chars)"},
    ...
    private static Map<String, Object> createValidOrganizationData(String orgName) {
        ...
        orgData.put("organization_id", "ORG_ABCDEFGH");
        orgData.put("address", "123, Main Street, Test Address");
        orgData.put("mandal_or_taluk", "Test Taluk");
        orgData.put("country_id", "IN");
        orgData.put("state_id", "4017");
        orgData.put("city_id", "12345");
        orgData.put("pincode", "560001");
        orgData.put("email", "test@test.com");
        orgData.put("phone", "9876543210");
        orgData.put("dialing_code_id", "1");
        orgData.put("organization_type", "private_limited");
        orgData.put("registration_number", "REG1234567890");
        orgData.put("document_number", "DOC12345678");
